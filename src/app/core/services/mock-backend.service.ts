      ...
      const sampleSubmissions: FormSubmission[] = [
        {
          id: 'sub_1',
          formId: 101,
          formCode: 'emp-feedback-2026',
          formName: 'Employee Feedback Form',
          submittedAt: new Date(Date.now() - 2 * 86400000).toISOString(),
          respondentName: 'Jane Smith',
          respondentEmail: 'jane.smith@company.com',
          responses: [
            { fieldId: 11, fieldName: 'employeeName', value: 'Jane Smith' },
            { fieldId: 12, fieldName: 'email', value: 'jane.smith@company.com' },
            { fieldId: 13, fieldName: 'department', value: 'Engineering' },
            { fieldId: 14, fieldName: 'satisfactionLevel', value: 'very_satisfied' },
            { fieldId: 15, fieldName: 'workplacePerks', value: ['flex_hours', 'learning'] },
            { fieldId: 16, fieldName: 'comments', value: 'Great team culture and strong engineering practices!' },
            { fieldId: 17, fieldName: 'reviewDate', value: '2026-09-15' },
          ],
        },
        {
          id: 'sub_2',
          ...
          respondentEmail: 'alex.rivera@company.com',
          responses: [
            { fieldId: 11, fieldName: 'employeeName', value: 'Alex Rivera' },
            { fieldId: 12, fieldName: 'email', value: 'alex.rivera@company.com' },
            { fieldId: 13, fieldName: 'department', value: 'Product' },
            { fieldId: 14, fieldName: 'satisfactionLevel', value: 'satisfied' },
            { fieldId: 15, fieldName: 'workplacePerks', value: ['remote', 'wellness'] },
            { fieldId: 16, fieldName: 'comments', value: 'Overall happy, would like more cross-team workshops.' },
          ],
        },
      ];
